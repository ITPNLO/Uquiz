...
public class VocaGridAdapter extends ArrayAdapter<VocaInfo> {
    Context mContext;
    LayoutInflater inflater;
    public VocaGridAdapter(Context context, List<VocaInfo> list){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        table_name.setText(String.valueOf(item.getVoca1()));
        return convertView;
    }
}
